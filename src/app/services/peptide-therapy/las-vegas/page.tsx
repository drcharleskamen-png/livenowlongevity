...
export const metadata: Metadata = {
 ...
 alternates: {
 canonical: '/services/peptide-therapy/las-vegas',
 },
 openGraph: {
 title: 'Peptide Therapy Las Vegas | Dr. Charles Kamen, MD | LiveNow Longevity',
 description: 'Physician-supervised peptide therapy in Las Vegas by board-certified neurologist Dr. Charles Kamen, MD.',
 url: 'https://livenowlongevity.com/services/peptide-therapy/las-vegas',
 siteName: 'LiveNow Longevity',
 type: 'website',
 images: [
  {
   url: '/api/og?title=Peptide%20Therapy%20Las%20Vegas&description=Physician-supervised%20peptide%20therapy%20in%20Las%20Vegas%20by%20Dr.%20Charles%20Kamen%2C%20MD.',
   width: 1200,
   height: 630,
...
const service = {
 ...
 intro: `Peptide therapy involving short chains of amino acids is available to Las Vegas residents through LiveNow Longevity. Dr. Charles Kamen, MD — a board-certified neurologist by the American Board of Psychiatry and Neurology — designs every peptide protocol after comprehensive medical evaluation.

Our Las Vegas clinic serves patients throughout the greater Las Vegas metro area, including Summerlin, Henderson, Southern Highlands, and Centennial Hills. Peptides are sourced from licensed American compounding pharmacies (503A/503B) that conduct third-party testing on every batch.
...
Peptide therapy is available via secure telemedicine for Nevada residents.`,
 ...
 faqs: [
  { q: 'Is peptide therapy available in Las Vegas?', a: 'Yes. Dr. Kamen provides peptide therapy to Las Vegas residents through LiveNow Longevity. Initial consultations are available in-person at our Las Vegas clinic or via secure telemedicine for Nevada residents.' },
...
export default function PeptideTherapyLasVegasPage() {
