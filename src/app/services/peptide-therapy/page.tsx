...
export const metadata: Metadata = {
 ...
 description: 'Physician-supervised peptide therapy in Las Vegas by board-certified neurologist Dr. Charles Kamen, MD. tissue repair peptide protocols, dual-action weight medication, weight management medication, growth hormone secretagogue protocols and more prescribed after medical evaluation.',
 keywords: 'peptide therapy Las Vegas, tissue repair peptide protocols Las Vegas, dual-action weight medication Las Vegas, weight management medication Las Vegas, peptide clinic Las Vegas, Dr. Charles Kamen peptides, growth hormone secretagogue protocols Las Vegas',
 ...
 openGraph: {
 title: 'Peptide Therapy Las Vegas | Dr. Charles Kamen, MD | LiveNow Longevity',
 description: 'Physician-supervised peptide therapy in Las Vegas. tissue repair peptide protocols, dual-action weight medication, weight management medication, and more prescribed after medical evaluation by a board-certified neurologist.',
...
Peptide therapy is available via secure telemedicine for Nevada residents.`,
 ...
 'tissue repair peptide protocols for support with tissue healing and inflammatory response',
 'dual-action weight medication and weight management medication as part of weight management programs when clinically appropriate',
 'melanocortin peptide protocols for support with arousal and libido',
 'growth hormone-releasing peptide protocols for growth hormone optimization',
 'growth hormone secretagogue protocols for growth hormone stimulation and body composition support',
 ...
 faqs: [
 { q: 'What peptides does Dr. Kamen prescribe at LiveNow Longevity?', a: 'Dr. Kamen may prescribe tissue repair peptide protocols, dual-action weight medication (weight management medication), weight management medication (weight management medication), melanocortin peptide protocols, growth hormone-releasing peptide protocols, growth hormone secretagogue protocols, and other peptides based on medical evaluation. Your specific protocol is determined during your consultation. All peptides are sourced from licensed US pharmacies.' },
 ...
 { q: 'Can peptide therapy support weight management?', a: 'Certain peptides, including weight management medications, may be incorporated into a weight management program when clinically appropriate. Dr. Kamen designs individualized weight management protocols based on medical evaluation and lab results.' },
