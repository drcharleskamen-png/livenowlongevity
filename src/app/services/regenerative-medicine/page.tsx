...
export const metadata: Metadata = {
 ...
 description: 'Physician-guided regenerative medicine protocols in Las Vegas by Dr. Charles Kamen, MD. Peptide therapy, wellness protocols, and advanced diagnostics to support natural healing processes.',
 ...
 title: 'Regenerative Medicine Las Vegas | Dr. Charles Kamen, MD | LiveNow Longevity',
 description: 'Physician-guided regenerative medicine protocols in Las Vegas by Dr. Charles Kamen, MD.',
...
const service = {
 ...
 heroSubtitle: 'Physician-guided wellness protocols to support health, energy, and vitality.',
...
At LiveNow Longevity in Las Vegas, Dr. Charles Kamen, MD, a board-certified neurologist by the American Board of Psychiatry and Neurology, offers individualized wellness protocols that may include peptide therapy, NAD+ support, and targeted nutritional interventions based on comprehensive medical evaluation.

Every protocol is built around your individual health profile — medical history, health goals, and evaluation results come first, before any recommendations are made.

Regenerative wellness protocols at LiveNow Longevity are grounded in evidence-based medicine. We do not offer unproven or unregulated treatments. All recommendations are based on what is medically appropriate for your individual situation.
...
Conditions that may be discussed include joint discomfort, fatigue, hormone imbalance, and general wellness concerns related to aging.`,
 ...
 { q: 'Is regenerative medicine safe?', a: 'When practiced by a licensed physician with proper patient evaluation and monitoring, regenerative wellness protocols are generally safe. All interventions used at LiveNow Longevity are evidence-based and appropriate for the individual patient.' },
 ...
 { q: 'Can regenerative protocols be combined with other therapies?', a: 'Depending on your medical evaluation, combination approaches may be appropriate. Dr. Kamen can review your health profile and discuss whether combining different wellness protocols is suitable for your situation.' },
 { q: 'Do I need labs before starting a regenerative protocol?', a: 'Medical evaluation including appropriate lab work is required before any recommendations are made. This ensures any protocol recommended is appropriate for your individual health status.' },
 { q: 'What peptides are used in regenerative protocols?', a: 'Based on medical evaluation, peptides such as tissue repair peptide protocols, growth hormone secretagogue protocols, and growth hormone-releasing peptide protocols may be recommended. All peptides are sourced from licensed US pharmacies with third-party testing. Protocol is determined by Dr. Kamen based on your individual evaluation.' },
 ],
