...
export const metadata: Metadata = {
 ...
 description: 'Medical weight management for Henderson and Summerlin residents supervised by board-certified neurologist Dr. Charles Kamen, MD. GLP-1/GIP medications and customized programs with physician evaluation and monitoring.',
...
Our clinic serves patients throughout Henderson, Summerlin, Green Valley, Seven Hills, and the greater Las Vegas metro area. Every program begins with medical evaluation including lab work before any intervention is recommended.
