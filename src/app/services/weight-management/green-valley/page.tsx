...
export const metadata: Metadata = {
 ...
 description: 'Medical weight management for Green Valley and Henderson residents supervised by board-certified neurologist Dr. Charles Kamen, MD. GLP-1/GIP medications and customized protocols with physician evaluation and ongoing monitoring.',
...
Our clinic serves patients throughout Green Valley, Henderson, and the eastern Las Vegas valley, including residents near the District at Green Valley Ranch, Galleria at Sunset, and the Green Valley Ranch Resort. Every protocol begins with medical evaluation including lab work before any intervention is recommended.
