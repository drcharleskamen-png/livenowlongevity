...
export const metadata: Metadata = {
 ...
 description: 'Medical weight management supervised by board-certified neurologist Dr. Charles Kamen, MD in Las Vegas. GLP-1/GIP medications and customized weight management protocols with medical evaluation and ongoing physician monitoring.',
 ...
 openGraph: {
 title: 'Weight Management Las Vegas | Dr. Charles Kamen, MD | LiveNow Longevity',
 description: 'Medical weight management supervised by board-certified neurologist Dr. Charles Kamen, MD. GLP-1/GIP medications and customized weight management protocols with medical evaluation and physician monitoring.',
 ...
 title: 'Weight Management Las Vegas | Dr. Charles Kamen, MD | LiveNow Longevity',
 description: 'Medical weight management supervised by board-certified neurologist Dr. Charles Kamen, MD. weight management medication protocols with physician monitoring.',
...
Dr. Charles Kamen, MD, a board-certified neurologist by the American Board of Psychiatry and Neurology at LiveNow Longevity in Las Vegas, uses medically supervised protocols — which may include weight management medications — as part of individualized weight management protocols tailored to each patient's health profile.

Every protocol begins with medical evaluation including lab work before any intervention is recommended. This ensures any protocol recommended is appropriate for your individual health status.
...
Medical weight management at LiveNow Longevity is physician-supervised. Dr. Kamen monitors progress, adjusts protocols as needed, and reviews labs regularly. Telemedicine consultations are available for Nevada residents.`,
 ...
 { q: 'What labs are included in the weight management evaluation?', a: 'Medical evaluation may include metabolic panels, hormone panels, and other markers depending on your health history. This helps ensure any recommended protocol is appropriate for your individual health status.' },
 ...
 { q: 'Are weight management medication medications safe?', a: 'weight management medications are FDA-approved medications with established safety profiles when prescribed and monitored by a licensed physician. Side effects vary by individual. Dr. Kamen reviews all safety information and monitors patients throughout their protocol.' },
 { q: 'Do I need to follow a diet and exercise plan?', a: 'Lifestyle modifications including nutrition and physical activity are typically recommended as part of a comprehensive weight management protocol. Dr. Kamen provides guidance tailored to your individual situation.' },
 { q: 'Can other therapies be combined with a weight management protocol?', a: 'Depending on your medical evaluation, additional supportive therapies may be appropriate. Dr. Kamen can discuss whether combination approaches are suitable for your individual health profile.' },
 { q: 'What is the difference between medical weight management and commercial diet protocols?', a: 'Medical weight management involves evaluation and oversight by a licensed physician, including labs, medication management when appropriate, and ongoing monitoring. Commercial protocols may not include physician oversight or medical evaluation.' },
 ],
