...
export const metadata: Metadata = {
 ...
 description: 'Medical weight management in Las Vegas supervised by board-certified neurologist Dr. Charles Kamen, MD. GLP-1/GIP medications and customized programs with medical evaluation and ongoing physician monitoring.',
 ...
 openGraph: {
 title: 'Weight Management Las Vegas | Dr. Charles Kamen, MD | LiveNow Longevity',
 description: 'Medical weight management in Las Vegas supervised by board-certified neurologist Dr. Charles Kamen, MD. GLP-1/GIP medications and customized weight management programs.',
...
Our Las Vegas clinic serves patients throughout the greater Las Vegas metro area, including Summerlin, Henderson, Southern Highlands, and Centennial Hills. Every program begins with medical evaluation including lab work before any intervention is recommended.
