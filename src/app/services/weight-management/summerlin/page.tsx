...
export const metadata: Metadata = {
 ...
 description: 'Medical weight management for Summerlin and The Ridges residents supervised by board-certified neurologist Dr. Charles Kamen, MD. GLP-1/GIP medications and customized protocols with physician evaluation and ongoing monitoring.',
...
Our clinic serves patients throughout the Summerlin area, including residents near Red Rock Canyon, The Ridges, Summerlin Village, and the 215 beltway corridor. Every protocol begins with medical evaluation including lab work before any intervention is recommended.
