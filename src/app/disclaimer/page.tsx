...
export default function DisclaimerPage() {
 ...
 <p>The information on this website is for educational purposes only and does not constitute medical advice, diagnosis, or treatment. Always consult a qualified physician before starting any medical treatment, therapy, or wellness protocol.</p>
 ...
 <p>Results from peptide therapy, longevity medicine, NAD+ IV therapy, weight management protocols, and other treatments discussed on this site may vary from person to person. No guarantees of specific results are made.</p>
 <h2>FDA Statement</h2>
